...
'(cons 1 (cons 23 (4 . 5)))
; expect (cons 1 (cons 23 (4 . 5)))

; Q7
(define x (begin (+ 2 2) (* 3 5)))
; expect x
...
; Q8
(define make-lambda (lambda (z) (* (-z 2) 100)))
make-lambda
; expect (lambda (z) (* (-z 2) 100))
...
; Q17
(define h (mu (x) (- (* (factorial x) y) z)))
(define s (lambda (x y z) (h x)))
(s 4 2 1)
; expect 47
